        ...
        <div className="max-w-md w-full mx-auto px-6">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 h-12 px-4 bg-secondary rounded-xl hover:bg-secondary/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
